...
layers_to_unfreeze = ['layer1.0.conv1', 'layer1.1.conv1', 'layer2.1.conv2', 'layer2.3.conv1', 'layer3.0.conv1',
                      'layer3.1.conv1', 'layer3.1.conv2', 'layer3.2.conv1', 'layer3.2.conv2', 'layer3.3.conv1',
                      'layer3.3.conv2', 'layer3.4.conv1', 'layer3.4.conv2', 'layer3.5.conv1', 'layer3.5.conv2',
                      'layer4.0.conv1', 'layer4.0.conv2', 'layer4.1.conv1', 'layer4.1.conv2', 'layer4.2.conv1']
time_log = {}
RUNS = 5
for BATCH_SIZE in [8, 16, 32]:
    for run in range(0, RUNS):
        ...
        df.to_csv(f"Resnet_34_Fine_Tuning_With_Entropy_Results_Kaggle_Batch_{BATCH_SIZE}_run_{run}_.csv")
        ...
        for phase in ['test']:
            for inputs, labels in dataloaders[phase]:
                ...
                idx += batch_size
        model_save_path = f'Resnet34_fine_tuning_with_entropy_batch_{BATCH_SIZE}_run_{run}_Kaggle_Model.pth'
        ...
        with open(f'Resnet34_predictions_labels_fine_tuning_with_entropy_batch_{BATCH_SIZE}_run_{run}_Kaggle.pkl', 'wb') as f:
            pickle.dump({
        ...
        training_inference_time.to_csv("Resnet_34_Time_Logs_Kaggle.csv", encoding='utf-8', index=False)
